...
- **Documentation:** canonical-source staging and a strict Zensical build on pull requests and `main`; publication remains disabled outside the release workflow.
