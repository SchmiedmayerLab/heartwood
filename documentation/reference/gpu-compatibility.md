...
2. OpenHands receives a native structured tool proposal;
...
The result records the GPU model, count, memory, driver, runtime versions, model revision, context size, tensor parallelism, and parser.
