...
docker run --rm -it \
  ...
  --env HOME=/tmp \
  -v "$PWD:/workspace" \
  ghcr.io/schmiedmayerlab/heartwood:0.2.0-beta.7-gpu-nvidia \
  heartwood
```
...
- `ghcr.io/schmiedmayerlab/heartwood:0.2.0-beta.7` — standard AMD64/ARM64 image;
- `ghcr.io/schmiedmayerlab/heartwood:0.2.0-beta.7-gpu-nvidia` — NVIDIA GPU image;
- `ghcr.io/schmiedmayerlab/heartwood:0.2.0-beta.7-terra` — Terra CPU image; and
- `ghcr.io/schmiedmayerlab/heartwood:0.2.0-beta.7-terra-gpu-nvidia` — Terra NVIDIA image.
