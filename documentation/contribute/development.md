...
Base images are pinned by digest, and third-party GitHub Actions use exact versions from immutable releases, with Dependabot proposing updates in the weekly group.
