...
Every validation job runs on standard GitHub-hosted runners; container builds and capable-model acceptance reclaim unused preinstalled toolchains first and reuse bounded GitHub Actions BuildKit caches.
