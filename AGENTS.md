...
| Deployment responsibilities, standard environment records, pilot evaluations, and platform extension contract | [documentation/operate/index.md](documentation/operate/index.md) |
| Heartwood–platform ownership boundary and platform requirements | [documentation/operate/platform-contract.md](documentation/operate/platform-contract.md) |
