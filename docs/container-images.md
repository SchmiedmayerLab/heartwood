...
- dedicated generic and Terra GPU validation stages that reuse the hash-locked vLLM dependency layer, import TorchCodec and vLLM, and reject embedded model artifacts through a cache-only BuildKit output;
